        ...
        <div class="content">
            ...
            <form  method="POST" action="login-provider">
                ...
                <div class="field space">
                    ...
                    name="password" value="${provider.password }">
                ...
                <div class="link">
                    ...
                    <a href="/login">
                        <i class="fa fa-loginasprovider"><span>login as user</span></i>
                        </a>
                       
                    </div>
                    <div class=" loginasadmin">
                        <a href="/adminlogin">
                        <i class="fa fa-loginasprovider"><span>login as admin
                        </span></i>
                        </a>
                    </div>
                </div>
